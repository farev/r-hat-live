  ...
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        green: "bg-emerald-500 hover:bg-emerald-400 hover:scale-105 duration-300 transition text-white shadow-lg shadow-emerald-500/50",
        red: "bg-red-500 hover:bg-red-400 hover:scale-105 duration-300 transition text-white shadow-lg shadow-red-500/50",
        destructive:
  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        {/* Glass effect overlay - minimal to show background color */}
        <div className="pointer-events-none absolute top-0 left-0 z-10 h-full w-full rounded-full 
            shadow-[inset_1px_1px_2px_rgba(255,255,255,0.15),inset_-1px_-1px_2px_rgba(0,0,0,0.1),0_2px_4px_rgba(0,0,0,0.05)] 
        transition-all opacity-30" />
        {/* Subtle highlight */}
        <div className="pointer-events-none absolute top-0 left-0 z-5 h-full w-full rounded-full bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-40" />
...
> = {
  ...
  green: {
    ...
    inner: "bg-gradient-to-b from-[#d1fae5] via-[#064e3b] to-[#a7f3d0]",
    button: "bg-gradient-to-b from-[#6ee7b7] to-[#047857]",
    textColor: "text-[#ecfdf5]",
    textShadow: "[text-shadow:_0_-1px_0_rgb(6_78_59_/_100%)]",
  },
  red: {
    outer: "bg-gradient-to-b from-[#7f1d1d] to-[#fca5a5]",
    inner: "bg-gradient-to-b from-[#fee2e2] via-[#7f1d1d] to-[#fecaca]",
    button: "bg-gradient-to-b from-[#fca5a5] to-[#dc2626]",
    textColor: "text-[#fef2f2]",
